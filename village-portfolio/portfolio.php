...
class Village_Portfolio {
	...
	function init() {
		...
		self::$prefix = apply_filters( "village_portfolio_prefix", "village_portfolio_" );
		self::$portfolio_key = apply_filters( self::$prefix . "meta_key", self::$prefix . 'project_images');
	}
	...
	public function setup_metabox() {
		...
		$meta_box = apply_filters( self::$prefix . 'meta_box', $meta_box['fields'] );
		$portfolio_content = apply_filters( self::$prefix . 'portfolio_content', $portfolio_content['fields'] );

		if( !empty( $meta_box['fields'] ) ) {
			new RW_Meta_Box( $meta_box );
		}

		if( !empty( $portfolio_content['fields'] ) ) {
